...
![Midjourney: Application of ML in Construction](images/01c_Computerhardware/mj_application_of_machine_learning_in_construction.png){class="midjourneyXX"}
</div>
...
![](images/01c_Computerhardware/image_1.wmf)
...
::: {.column width="60%"}
<div class="midjourneyXX_frame">
![DALL-E 2: A Mona Lisa-style painting with a goat taking a photo with an iPad](images/01c_Computerhardware/image_3.png){class="midjourneyXX"}
</div>
:::
::::
...
## Computer Hardware
![](images/01c_Computerhardware/computer_hardware.svg){width=60%}



## Computer Hardware
![](images/01c_Computerhardware/computer_hardware2.svg){width=60%}
...
::: {.column width="60%"}
<div class="midjourneyXX_frame">
![DALL-E 2: An alien supermarket filled with exotic food](images/01c_Computerhardware/image_15.jpg){class="midjourneyXX"}
</div>
:::
::::
